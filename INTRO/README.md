...
| [**2: HTML**](units/unit2)                           |  6 Lessons <br> 1 Individual Project - Continued in Unit 3              | <ul><li>Describe how web pages are built</li> <li> Use HTML syntax and structure to create a simple webpage</li> <li> Create HTML elements with attributes to add links to their pages </li><li>Render an image on a webpage</li>  <li> Debug their code by using their available resources to find and fix errors. </li><li>Build a sense of belonging in the tech industry</li><li>Interview a partner and build HTML page</li></ul>                                                                                                                                                                                                                                                                                                                                  |
