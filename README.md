<p align="center"> <img src="https://i.ibb.co/XpTcsfN/Code-Nation.png"></p>
...
| [Intro to Web Development [ONE SEMESTER]](INTRO)      | Please use this curriculum portal if you are teaching an Intro class that is **ONLY one semester.** It still reveals HTML, CSS, and JavaScript, but due to the shorter length, has a slightly different number and order of lessons. |
